...
export default function ProjectDetail({ mode }: Props) {
  ...
  const detailPath = mode === 'projects' ? '/projects' : '/cases';
    ...
    <PageTransition>
      <div className="absolute inset-0 overflow-y-auto">
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between px-8 py-5" style={{ background: item.accentColor }}>
          ...
          <h1
            className="text-white text-[1.25rem] font-semibold tracking-widest uppercase"
