        ...
        {images.length > 0 && (
          <div className="relative w-full">
            ...
            <div className="relative min-w-0 flex-1 overflow-hidden">
              ...
              {images.length > 1 && (
                <div className="flex items-center justify-center gap-1 pt-3 pb-1 min-[900px]:flex">
                  {images.map((img, i) => (
                    <button
                      key={img.id}
                      onClick={() => goTo(i)}
    ...
    <div className="select-none">
      ...
      <div className="relative w-full">
        ...
        <div className="relative min-w-0 flex-1 overflow-hidden">
          ...
          {/* Dots */}
          {images.length > 1 && (
            <div className="flex items-center justify-center gap-1.5 pt-3 pb-1 min-[900px]:flex">
              {images.map((img, i) => (
                <button
                  key={img.id}
                  onClick={() => goTo(i)}
